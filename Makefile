...
sqlc:
	docker run --rm -v "C:\Users\Dell\go\simplebank:/src" -w /src kjconroy/sqlc generate
...
server:
	go run main.go
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/deeprath/simplebank/db/sqlc Store
